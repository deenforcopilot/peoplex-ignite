    ...
    <section id="contact" className="py-32 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          <div className="glass-card p-12 md:p-16 rounded-3xl border-2 border-primary/30 animate-fade-in-up text-center">
            ...
            <Button size="lg" className="gradient-orange group text-lg px-12 py-6 hover:scale-105 transition-all">
              {t('contact.cta')}
